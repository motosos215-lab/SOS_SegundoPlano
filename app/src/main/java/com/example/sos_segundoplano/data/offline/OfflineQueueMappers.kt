...
fun OfflineSyncPayload.toNewEntity(
    ...
    currentRemoteTripId: String? = null,
    ...
    ownerUserId = bundleMetadata?.ownerUserId ?: currentOwnerUserId?.trim()?.takeIf { it.isNotEmpty() },
    bundleKey = bundleMetadata?.bundleKey,
    remoteTripId = bundleMetadata?.remoteTripId ?: currentRemoteTripId?.trim()?.takeIf { it.isNotEmpty() },
